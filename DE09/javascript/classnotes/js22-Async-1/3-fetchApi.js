...
//? fetch() fonksiyonu veri getirmek istediginiz kaynagin yolunu gosteren zorunlu bir parametre almaktadir
//? ve bu istegin cevabini gosteren bir Promise dondurmektedir.
...
// fonksiyonda yazmak daha best practise
// ama bazı yerlerde(galiba async await ile) fonksiyon kullanmak zorundayız
...
const getirData = () =>{
    ...
    return res.json()
}).then((veri) => ekranaBastir(veri)) //ekrana bastırma then'in içi
} 
