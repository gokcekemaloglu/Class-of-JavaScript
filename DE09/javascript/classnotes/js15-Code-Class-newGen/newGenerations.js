...
userTodos.filter((a)=>a.userId===1 && a.completed===true).forEach((a)=>console.log(`User 1 completed the title that is: ${a.title}`))
...
//! Eğer sıfırdan bir object'in içini elimdeki dizideki verilerden bazılarıyla doldurmak istiyorsam, öncesinde object'im boş olduğu için dot notation ile (sayılar.category) yapamam. Bu yüzden square bracket kullanmalıyım (sayılar[category])
...
const customerList = [
  ...
  customerList.filter((a)=>a.name).forEach((a)=>console.log(a))
